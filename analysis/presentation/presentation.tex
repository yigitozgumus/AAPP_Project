...
\begin{document}
	...
	\begin{frame}
		...
		\uncover<2>{Project itself and all the additional materials including this presentation can be downloaded from \href{https://github.com/yigitozgumus/AAPP_Project}{\color{blue}https://github.com/yigitozgumus/AAPP\_Project}}
	\end{frame}
\end{document}