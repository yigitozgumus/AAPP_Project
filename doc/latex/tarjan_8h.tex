...
\begin{DoxyCompactList}\small\item\em This class contains the implementation of algorithms from the \hyperlink{class_tarjan}{Tarjan}\textquotesingle{}s paper. \end{DoxyCompactList}\end{DoxyCompactItemize}
